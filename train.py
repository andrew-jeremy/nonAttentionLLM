...
This is a toy example for demonstration purposes of the key concepts ONLY. 
For real-world applications, consider using more advanced memory modules (LSH-based retrievers, FAISS, Annoy, 
Scann, HNSW, etc.) and larger-scale datasets

 Andrew Kiruluta, UC Berkeley, Feb 2025
'''
import math
import torch
...
###################################################
#  DATA LOADING: CNN/DAILYMAIL w/ BPE TOKENIZER
#  modify this class to load your own dataset
###################################################
...
#####################################################
#  TRAIN/VAL/TEST + PERPLEXITY (SINGLE-CELL DEMO)
#####################################################
...
if __name__ == "__main__":
    ...
    #----> Load subsets of CNN/DailyMail dataset - Toy dataset. Replace with your own
